...
if ($variables["server_down"]==1){
    ...
    echo "the server is down. its doing something with the submissions. we should be back soon :-P. if this ever takes more than 10 minutes email me. -Taylor <br>";
    ...
    echo "<br> EXIT STATUS: " . $exitstatus . " (if this is anything other than zero, report this to me immediately.) <br>";
